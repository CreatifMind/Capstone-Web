...
<head>
  ...
  <title>PurityLoop AI | Classification Results</title>
...
<body data-page="live-stream" class="ops-pro-page lab-ui lab-app dark-ai dark-app">
  <div class="app-layout">
    ...
    <aside id="appSidebar" class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="result.php" class="nav-item active" data-tooltip="Result">
