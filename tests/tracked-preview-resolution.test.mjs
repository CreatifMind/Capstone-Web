...
test("Review renders target object highlight overlay for tracked-video previews", () => {
  assert.match(source, /const isTrackedVideo = \["tracked_video_object", "video_track_object"\]/);
  assert.match(source, /Target Object/);
});
