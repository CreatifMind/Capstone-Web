      ...
      <div class="page-body">
        <section class="analytics-overview" aria-label="Analytics overview">
          ...
          <section class="analytics-kpi-grid" aria-label="Analytics key performance indicators">
            <article class="analytics-kpi analytics-kpi-review" data-drill-target="detail-purity" tabindex="0" role="button"><span class="analytics-kpi-icon"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i></span><span>Objects Needing Review</span><strong data-overview="needs-review">-</strong><p data-overview="needs-review-note">Loading analytics...</p><small data-overview="needs-review-compare" hidden></small></article>
            <article class="analytics-kpi" data-drill-target="detail-ledger" tabindex="0" role="button"><span class="analytics-kpi-icon"><i class="fa-solid fa-circle-check" aria-hidden="true"></i></span><span id="analyticsConfirmedLabel">Confirmed Objects</span><strong data-overview="confirmed-today">-</strong><p>Confirmed object records</p><small data-overview="confirmed-today-compare" hidden></small></article>
            <article class="analytics-kpi" data-drill-target="detail-resale" tabindex="0" role="button"><span class="analytics-kpi-icon"><i class="fa-solid fa-sack-dollar" aria-hidden="true"></i></span><span>Estimated Recovery Value</span><strong data-overview="recoverable-value">-</strong><p>Illustrative category estimate</p><small data-overview="recoverable-value-compare" hidden></small></article>
            <article class="analytics-kpi" data-drill-target="detail-purity" tabindex="0" role="button"><span class="analytics-kpi-icon"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i></span><span>Average Detection Confidence</span><strong data-overview="average-confidence">-</strong><p>Across detected items</p><small data-overview="average-confidence-compare" hidden></small></article>
          </section>
