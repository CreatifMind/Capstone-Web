...
export default function AdminUsersClient() {
  ...
  const canManageUsers = profile?.role === "admin" || profile?.role === "plant_manager";
  const canDeleteUsers = profile?.role === "admin";
